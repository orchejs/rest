...
export class ClassicalMusics {
  @get()
  list(): ClassicalMusic[] {
    return [new ClassicalMusic('123', 'The marriage of Figaro')];
  }
}

describe('Route decorator tests', () => {
  it('Should create an endpoint with Route, using the classname as path, transformed to spinal-case', async () => {
